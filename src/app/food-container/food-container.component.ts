...
import { dishModel } from './models/food_divs';
...
export class FoodContainerComponent implements OnInit {
  ...
  public dish : dishModel =
    {
      name: "Ceviche",
      img: {
        src : 'https://jameaperu.com/wp-content/uploads/2020/05/ceviche-peruano-original_700x465.jpg',
        alt: 'Imagen de Ceviche'
      },
  ...
  ngOnInit(): void {
    this.dishList.push({
      name : 'Paella',
      img:{
        src: "https://images.aws.nestle.recipes/resized/bad4d3b51ce0e061b4ed00574e00ed03__0015_16_-__Paella_1200_600.jpg",
        alt: "Imagen de paella"
      },
    ...
    },
    {
      ...
      img:{
        src: 'https://www.elespectador.com/resizer/Ny-8ZVbpvafu_INBbXmaPBbyKRk=/525x350/filters:format(jpeg)/cloudfront-us-east-1.images.arcpublishing.com/elespectador/D2KL4RRCRJA7RJC5TNULFZEKR4.jpg',
        alt: 'Imagen de pizza'
      },
      description: 'La pizza margarita es una típica pizza napolitana elaborada con tomate, mozzarella (tradicionalmente se usa el Fior di latte), albahaca fresca, sal y aceite. Se trata de la pizza napolitana más popular, junto con la marinera.',
      ingredients: ['Masa de pizza', "Tomate", "Queso mozzarella", "Albahaca"],
